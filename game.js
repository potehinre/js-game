var Game = function(canvas)
{
    ...
    this.walls = [new Wall(0,400,600,200),new Wall(300,150,100,50),new Trampoline(300,370,150,30)];
...
Game.prototype.mainLoop = function()
{
    ...
    var mainloop = function()
    {
        ...
        if(!landed && !self.player.isJumping() && !self.player.isFalling()) self.player.startFalling();
        self.player.move();
        self.render.begin();
